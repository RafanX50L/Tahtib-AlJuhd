...
//   // Mock user data (replace with actual useSelector in your app)
//   //   const user = { _id: "user123", name: "John Doe", email: "john@email.com" };
//   const { user } = useSelector((state: RootState) => state.auth);

//   // Mock params and navigation (replace with actual useParams and useNavigate in your app)
...
//     try {
//       // const response = await ClientService.purchasePlan(
//       //   user._id,
//       //   trainer.id,
//       //   selectedPlan
//       // );
//       const response = await ClientService.createPymentIntent(selectedPlan.price, "inr", selectedPlan._id, user._id);
//       setShowConfirmModal(false);
...
//       } else {
//         // toast.success('Plan purchased successfully! Check your email for confirmation.');
//         alert(
...
//         {/* Purchase Confirmation Modal with Checkout */}
...
//                     {trainer.plans.find((plan) => plan._id === selectedPlan)?.name}
//                   </h4>
//                   <div className="space-y-2 text-sm text-gray-300">
//                     <p>
//                       Price: ₹
//                       {trainer.plans.find((plan) => plan._id === selectedPlan)?.price}
//                     </p>
//                     <p>
//                       Sessions:{" "}
//                       {trainer.plans.find((plan) => plan._id === selectedPlan)
...
//                     <p>
//                       Duration:{" "}
//                       {trainer.plans.find((plan) => plan._id === selectedPlan)?.duration}
//                     </p>
//                   </div>
//                 </div> */}

//                 {/* Stripe Checkout form here */}
//                 {/* <Checkout
//                   planId={selectedPlan}
//                   userId={user?._id || ""}
//                   amount={
//                     (trainer.plans.find((p) => p._id === selectedPlan)?.price || 0) * 100
//                   } // Stripe takes cents
//                   currency="inr"
//                 /> */}
//                 {/* <Checkout
//                   planId={selectedPlan}
//                   userId={user?._id || ""}
//                   amount={(trainer.plans.find((p) => p._id === selectedPlan)?.price || 0) * 100}
//                   currency="inr"
//                 />
...
//             {selectedPlan &&
//             trainer.plans.find((plan) => plan._id === selectedPlan._id) ? (
//               <div className="space-y-4">
//                 <div className="bg-[#2c2c2c] rounded-lg p-4">
//                   <h4 className="font-semibold text-lg mb-2">
//                     {
