                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {currentFieldConfig.options && currentFieldConfig.options.map((option) => (
                              <div
                                ...
                                onClick={() => {
                                  const currentEquipment = field.value || [];
                                  if (Array.isArray(currentEquipment) && currentEquipment.includes(option.value as any)) {
                                    field.onChange(currentEquipment.filter((item) => item !== option.value));
                              ...
                              >
                                ...
                                <div
                                  className={cn(
                                    "absolute inset-0 bg-gradient-to-r from-indigo-600/10 to-purple-600/10 opacity-0 transition-opacity",
                                    Array.isArray(field.value) && field.value.includes(option.value as any) ? "opacity-100" : "group-hover:opacity-50"
                                  )}
                                />
                              </div>
                            ))}
