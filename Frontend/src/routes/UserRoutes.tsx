...
import NotificationsPage, { clientTheme } from '@/components/shared/Notification';
...
const UserRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/notifications" element={<NotificationsPage theme={clientTheme}backPath="/dashboard"/>} />
