...
exports.sendTrainerRejectionEmail = exports.sendTrainerApprovalEmail = exports.sendInterviewScheduleEmail = exports.sendPasswordResetEmail = exports.sendOtpEmail = void 0;
const mail_config_1 = require("../config/mail.config");
const env_config_1 = require("../config/env.config");
const sendOtpEmail = async (email, otp) => {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env_config_1.env.SENDER_EMAIL}>`,
            to: email,
...
const sendPasswordResetEmail = async (email, token) => {
    try {
        const resetLink = `${env_config_1.env.RESET_PASS_URL}?token=${token}`;
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env_config_1.env.SENDER_EMAIL}>`,
            to: email,
...
const sendInterviewScheduleEmail = async (email, trainerName, date, time) => {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env_config_1.env.SENDER_EMAIL}>`,
            to: email,
...
exports.sendInterviewScheduleEmail = sendInterviewScheduleEmail;
const sendTrainerApprovalEmail = async (email, trainerName) => {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env_config_1.env.SENDER_EMAIL}>`,
            to: email,
            ...
            <div class="email-container">
                ...
                <div class="content">
                    ...
                    <div class="cta-section">
                        ...
                        <a href="${env_config_1.env.TRAINER_DASHBOARD_URL || '#'}" class="cta-button">
...
exports.sendTrainerApprovalEmail = sendTrainerApprovalEmail;
const sendTrainerRejectionEmail = async (email, trainerName) => {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env_config_1.env.SENDER_EMAIL}>`,
            to: email,
...
exports.sendTrainerRejectionEmail = sendTrainerRejectionEmail;
