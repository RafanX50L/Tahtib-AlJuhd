...
export const sendOtpEmail = (email, otp) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mailOptions = {
...
export const sendPasswordResetEmail = (email, token) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
export const sendInterviewScheduleEmail = (email, trainerName, date, time) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env.SENDER_EMAIL}>`,
            to: email,
...
export const sendTrainerApprovalEmail = (email, trainerName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env.SENDER_EMAIL}>`,
            to: email,
...
export const sendTrainerRejectionEmail = (email, trainerName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const mailOptions = {
            from: `"Tahtib ALJuhd" <${env.SENDER_EMAIL}>`,
            to: email,
