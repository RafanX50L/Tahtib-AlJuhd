...
function generateFitnessPlan(userData_1, weekNumber_1, planType_1) {
    return __awaiter(this, arguments, void 0, function* (userData, weekNumber, planType, previousWeekWorkoutData = null) {
        try {
...
const generateWorkoutReport = (exercises) => __awaiter(void 0, void 0, void 0, function* () {
...
`;
    const response = yield genAIS.models.generateContent({
        model: "gemini-2.0-flash",
        contents: [{ role: "user", parts: [{ text: prompt }] }],
    });
    const textResponse = (response === null || response === void 0 ? void 0 : response.text) || "";
...
const generateExercisesForWeek = (type) => __awaiter(void 0, void 0, void 0, function* () {
    try {
