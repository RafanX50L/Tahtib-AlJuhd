...
// });
const ClientPersonalizationSchema = new Schema({
    planStatus: {
        type: String,
...
const AdminPersonalizationSchema = new Schema({
    adminNotes: { type: String, required: false },
});
const TrainerPersonalizationSchema = new Schema({
    basicInfo: {
...
export const PersonalizationModel = model("Personalization", PersonalizationSchema);
