...
exports.PersonalizationModel = void 0;
...
// });
const ClientPersonalizationSchema = new mongoose_1.Schema({
    planStatus: {
        type: String,
    ...
    dietPlanId: { type: mongoose_1.Schema.Types.ObjectId, ref: "DietPlan", default: null },
    progressLogId: {
        type: mongoose_1.Schema.Types.ObjectId,
        ref: "ProgressLog",
        required: false,
    ...
    sessionsId: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Session", default: [] }],
    chatsId: [
    ...
    contracts: [
        { type: mongoose_1.Schema.Types.ObjectId, ref: "TrainerClientContract", default: [] },
    ],
});
const AdminPersonalizationSchema = new mongoose_1.Schema({
    adminNotes: { type: String, required: false },
});
const TrainerPersonalizationSchema = new mongoose_1.Schema({
    basicInfo: {
    ...
    evaluation: {
        ...
        evaluatedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: false },
    ...
    sessions: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Session", default: [] }],
    chats: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Chat", default: [] }],
    plans: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Plan", default: [] }], // New
    contracts: [
        { type: mongoose_1.Schema.Types.ObjectId, ref: "TrainerClientContract", default: [] },
    ],
});
        ...
        validate: {
            validator: async function (value) {
                ...
                try {
                    ...
                    const TempModel = mongoose_1.default.models[modelName] || mongoose_1.default.model(modelName, schema);
...
exports.PersonalizationModel = (0, mongoose_1.model)("Personalization", PersonalizationSchema);
//# sourceMappingURL=Personalization.model.js.map