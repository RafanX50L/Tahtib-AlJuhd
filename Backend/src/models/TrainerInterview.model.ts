...
const trainerInterviewSchema = new Schema<ITrainerInterview>(
  {
...
export const TrainerInterviewModel = model<ITrainerInterview>("TrainerInterview", trainerInterviewSchema);