...
import { IAdminPersonalization, IClientPersonalization, IPersonalization, ITrainerPersonalization } from '@/core/interface/model/IPersonalization.model';
...
const TrainerPersonalizationSchema = new Schema<ITrainerPersonalization>({
  ...
  interviewDetailsId: { type: Schema.Types.ObjectId, ref: "TrainerInterview", default: null },
