...
import { IExercise, IWeek } from "@/core/interface/model/IWorkoutPlan.model";
...
async function generateFitnessPlan(
  ...
  previousWeekWorkoutData: Record<string, IWeek> | null = null
) {
  try {
...
//       : "";
  ...
  const generateSingleWeekStructure = (
    currentWeekNum: number,
    workoutDaysPerWeek: number
  ) => {
    let days = "";
...
const generateExercisesForWeek = async (type: ChallengeType) => {
  try {
      ...
      const beginnerDummyPool: Partial<IExercise>[] = [
        {
          ...
          rest: "30 seconds",
          instructions:
            "Start with feet together, jump while spreading legs and arms, then return to start.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Stand facing a wall, place hands shoulder-width apart and perform a push-up.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Stand in front of a chair, lower until seated, then stand back up.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "On all fours, extend opposite arm and leg while keeping core stable.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Lie on your back, knees bent, lift hips off the ground.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Support yourself on one forearm and knees, keeping body straight.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Alternately tap your toes to the ground in front of you.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Lie on back, knees bent, lift head and shoulders off floor.",
        ...
        },
        {
          ...
          rest: "30 seconds",
          instructions:
            "Move spine from rounded to arched position on all fours.",
          animationLink: "https://example.com/cat-cow",
        },
      ];

      // New Intermediate Pool
      const intermediateDummyPool: Partial<IExercise>[] = [
        {
          ...
          rest: "45 seconds",
          instructions:
            "Perform push-ups with hands shoulder-width apart, keeping body straight.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Squat down as if sitting in a chair, keeping chest up and back straight.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Step forward into a lunge, then continue forward with the opposite leg.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Hold body in a straight line from head to heels on your forearms.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Lie on back, bring opposite elbow to knee, mimicking cycling.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Use a sturdy bench or chair for dips, lowering your body by bending elbows.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Step onto a sturdy elevated surface, focusing on the leg pushing up.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Perform a push-up, then jump feet out and in like a jumping jack in plank position.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Support yourself on one forearm and foot, keeping body straight.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Lie on your back, lift your legs with knees bent, and curl your hips towards your chest.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Perform push-ups with hands elevated on a bench or sturdy surface.",
          animationLink: "https://example.com/incline-pushups",
        },
      ];

      const advancedDummyPool: Partial<IExercise>[] = [
        {
          name: "Burpees",
          sets: 3,
          reps: "15",
          rest: "45 seconds",
          instructions:
            "Drop into push-up position, push-up, jump feet forward, leap up.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Keep body straight, lower until chest nearly touches the ground, then push back up.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Perform a squat, then explode up into a jump and land softly.",
        ...
        },
        {
          ...
          rest: "60 seconds",
          instructions:
            "Use a band for assistance or focus on the lowering phase.",
        ...
        },
        {
          ...
          rest: "60 seconds",
          instructions:
            "Use a support for balance while performing a single-leg squat.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "From a side plank, reach your top arm under and through.",
        ...
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Twist torso side-to-side while leaning back, holding a weight.",
          animationLink: "https://example.com/russian-twists",
        },
        {
          ...
          rest: "45 seconds",
          instructions:
            "Use a chair for dips, lowering your body by bending elbows.",
        ...
        },
        {
          ...
          rest: "60 seconds",
          instructions:
            "Perform a lunge, then jump and switch legs in mid-air.",
          animationLink: "https://example.com/plyo-lunges",
        },
      ];

      let exercisePool: Partial<IExercise>[] = [];
      if (type === "beginner") {
    ...
    const weeklyTasks = [];
    for (let i = 0; i < 7; i++) {
      const dailyExercises = generatedExercises.slice(
        i * numDailyExercises,
        (i + 1) * numDailyExercises
      );
      weeklyTasks.push({
